...
//       const filtered = data.contests.filter(c => c.winnerId);
//       console.log('Contests with winners:', filtered);
...
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
//             {recentWinners.slice(0, 6).map((contest, index) => {
//               const winnerData = typeof contest.winnerId === 'object' 
//                 ? contest.winnerId 
//                 : { _id: contest.winnerId, name: 'Unknown Winner', photo: '/default-avatar.png' };
              
//               console.log(`Contest ${contest.name} winner:`, winnerData);
...
//                 >
//                   {index === 0 && (
//                     <div className="px-4 py-2 font-bold text-sm flex items-center gap-2 bg-yellow-50">
//                       <FaCrown /> Top Winner
//                     </div>
//                   )}
...
//                       <div className="flex items-center gap-3 mb-4">
//                         <img
//                           src={winnerData.photo || '/default-avatar.png'}
//                           alt={winnerData.name}
...
//                         <div className="flex-1">
//                           <div className="font-bold ">
//                             {winnerData.name || 'Unknown Winner'}
//                           </div>
//                           <div className="text-sm ">Winner</div>
//                         </div>
//                         <FaMedal className="text-2xl text-yellow-500" />
